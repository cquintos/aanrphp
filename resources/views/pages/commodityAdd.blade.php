                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="edit">
                        <div class="card shadow-lg my-4">
                            <div class="card-header px-5 pt-2" ><span class="title">CREATE COMMODITY</span></div>
                            <div class="card-body">
                                {{ Form::open(['action' => ['CommoditiesController@add'], 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                                <div class="form-group row d-flex justify-content-around" id="basic_info">
                                    ...
                                    <div class="col-sm-5">
                                        ...
                                        {{Form::text('name', '', ['class' => 'form-control', 'placeholder' => 'Add a name', 'maxlength' => '40'])}}
                                        <h5>{{Form::label('industry_name', 'Industry', ['class' => 'col-form-label required'])}}</h5>
                                        {{Form::select('industry', $industries, '',['class' => 'form-control', 'placeholder' => 'Select Industry']) }}
                                    </div>
                                    <div class="col-sm-5">
