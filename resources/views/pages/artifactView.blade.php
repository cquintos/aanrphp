...
<?php
    ...
    $consortia_member_name = App\ConsortiaMember::find($artifact->consortia_member_id);
    $content_sub_type = App\ContentSubtype::find($artifact->contentsubtype_id);
    $content_type = App\Content::find($artifact->content_id)->type;

    if($consortia_member_name) {
        $consortia_member_name = $consortia_member_name->name;
    }
    
    if($content_sub_type) {
        $content_sub_type = $content_sub_type->name;
    }
?>
                                ...
                                <div class="form-group row d-flex justify-content-around">
                                    ...
                                    <div class="col-sm-5">
                                        ...
                                        <h5>{{Form::label('commodity', 'Commodities', ['class' => 'col-form-label'])}}</h5>
                                            {{Form::select('commodities[]', $commodities, null, ['class' => 'form-control multi-commodity-edit w-100', 'multiple' => 'multiple', 'disabled'])}}
                                        <h5>{{Form::label('commodity_subtype', 'Commodity Subtype', ['class' => 'col-form-label'])}}</h5>
                                            {{Form::select('commodity_subtypes[]', $commodity_subtypes, null, ['class' => 'form-control multi-subcommodity-edit w-100', 'multiple' => 'multiple', 'disabled'])}}
                                        <h5>{{Form::label('is_gad', 'GAD Focus?', ['class' => 'col-form-label mb-1'])}}</h5>
                                        <label class="mr-2 radio-inline"><input type="radio" name="is_gad" value="1" {{$artifact->is_gad == 1 ? 'checked': 'disabled'}}> Yes</label>
                                        <label class="mx-2 radio-inline"><input type="radio" name="is_gad" value="0" {{$artifact->is_gad == 0 ? 'checked': 'disabled'}}> No</label>
                                    </div>
                                    <div class="col-sm-11">
                                        ...
                                        <h5>{{Form::label('description', 'Description', ['class' => 'col-form-label'])}}</h5>
                                            {{Form::textarea('description', $artifact->description, ['class' => 'form-control', 'disabled'])}}
                                    </div>
                                </div>
                                <div class="form-group row d-flex justify-content-aroundd-flex justify-content-around">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <h5>{{Form::label('embed_link', 'Embed Link', ['class' => 'col-form-label'])}}</h5>
                                            {{Form::text('embed_link', $artifact->embed_link, ['class' => 'form-control', 'disabled'])}}
                                    </div>
                                </div>
                                <div class="form-group row d-flex justify-content-around" id="keywords">
                                    ...
                                    <div class="col-sm-11">
                                        <h5>{{Form::label('keywords', 'Search keywords', ['class' => 'col-form-label'])}}</h5>
                                            {{Form::text('keywords', $artifact->keywords, ['class' => 'form-control', 'disabled'])}}
                                    </div>
                                </div>
