...
// This file contains request handling logic for PCAARRD page's CMS.
// functions included are:
//     editPCAARRDPage(Request $request, $consortia_id)
//     editPCAARRDPageBanner(Request $request, $consortia_id)
//     editPCAARRDPageDetails(Request $request, $consortia_id)
//
...
class PCAARRDPageController extends Controller
{
    public function editPCAARRDPage(Request $request, $consortia_id)
    {
        ...
        if ($pcaarrd_page == null) {
            return redirect()->back()->with('error', 'PCAARRD page not found.');
        }
