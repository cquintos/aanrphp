...
// This file contains request handling logic for Consortia Members.
// functions included are:
//     addConsortiaMember(Request $request)
//     editConsortiaMember(Request $request, $consortia_member_id)
//     editAANRPageDetails(Request $request, $consortia_id)
//     deleteConsortiaMember(Request $request, $consortia_member_id)
//
// This file also contains request handling logic for Unit About page.
// functions included are:
//     editConsortiaMemberBanner(Request $request, $consortia_member_id)
//     editConsortiaMemberDetails(Request $request, $consortia_member_id)
//
...
class ConsortiaMembersController extends Controller
{
    ...
    public function editConsortiaMember(Request $request, $consortia_member_id)
    {
        ...
        if ($consortia_member == null) {
            return redirect()->back()->with('error', 'Consortia member not found.');
        }
